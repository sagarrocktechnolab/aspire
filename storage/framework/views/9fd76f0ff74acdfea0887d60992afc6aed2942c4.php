                         ...
                         <div class="box-body">
                            ...
                            <?php echo Form::open(array('url' =>'admin/updateCustomers', 'method'=>'post', 'class' => 'form-horizontal form-validate', 'enctype'=>'multipart/form-data')); ?>
                                ...
                                <div class="form-group">
                                  ...
                                  <div class="col-sm-10 col-md-4">
                                   <?php echo Form::hidden('old_email_address',  $data['customers'][0]->customers_email_address, array('class'=>'form-control', 'id'=>'old_email_address')); ?>

                                    <?php echo Form::email('customers_email_address',  $data['customers'][0]->customers_email_address, array('class'=>'form-control email-validate', 'id'=>'customers_email_address')); ?>
                               ...
                               <div class="form-group">
                                  ...
                                  <div class="col-sm-10 col-md-4">
                                    <input type="password" name="customers_password" value="<?php echo e($data['customers'][0]->customers_password); ?>" class="form-control field-validate" id="customers_password"> 
