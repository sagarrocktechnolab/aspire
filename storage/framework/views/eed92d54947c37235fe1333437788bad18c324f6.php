                        ...
                        <!-- form start -->                        
                         <div class="box-body">
                            ...
                            <div class="form-group">
								...
								<div class="col-sm-10 col-md-4">
									<?php echo Form::text('braintree_name', $result['shipping_methods'][0]->braintree_name, array('class'=>'form-control field-validate', 'id'=>'braintree_name')); ?>
							...
							<div class="form-group">
								...
								<div class="col-sm-10 col-md-4">
									<?php echo Form::text('braintree_merchant_id', $result['shipping_methods'][0]->braintree_merchant_id, array('class'=>'form-control field-validate', 'id'=>'braintree_merchant_id')); ?>
							...
							<div class="form-group">
								...
								<div class="col-sm-10 col-md-4">
									<?php echo Form::text('braintree_public_key',  $result['shipping_methods'][0]->braintree_public_key, array('class'=>'form-control field-validate', 'id'=>'braintree_public_key')); ?>
                            ...
                            <div class="form-group">
								...
								<div class="col-sm-10 col-md-4">
									<?php echo Form::text('braintree_private_key',  $result['shipping_methods'][0]->braintree_private_key, array('class'=>'form-control field-validate', 'id'=>'braintree_private_key')); ?>
                            ...
                            <div class="form-group">
								...
								<div class="col-sm-10 col-md-4">
									<?php echo Form::text('stripe_name', $result['shipping_methods'][0]->stripe_name, array('class'=>'form-control field-validate', 'id'=>'stripe_name')); ?>
                            ...
                            <div class="form-group">
								...
								<div class="col-sm-10 col-md-4">
									<?php echo Form::text('secret_key', $result['shipping_methods'][0]->secret_key, array('class'=>'form-control field-validate', 'id'=>'secret_key')); ?>
							...
							<div class="form-group">
								...
								<div class="col-sm-10 col-md-4">
									<?php echo Form::text('publishable_key',  $result['shipping_methods'][0]->publishable_key, array('class'=>'form-control field-validate', 'id'=>'publishable_key')); ?>
                            ...
                            <div class="form-group">
								...
								<div class="col-sm-10 col-md-4">
									<?php echo Form::text('paypal_name', $result['shipping_methods'][0]->paypal_name, array('class'=>'form-control field-validate', 'id'=>'paypal_name')); ?>
                            ...
                            <div class="form-group">
								...
								<div class="col-sm-10 col-md-4">
									<?php echo Form::text('paypal_id', $result['shipping_methods'][0]->paypal_id, array('class'=>'form-control field-validate', 'id'=>'paypal_id')); ?>
                            ...
                            <div class="form-group">
								...
								<div class="col-sm-10 col-md-4">
									<?php echo Form::text('cod_name', $result['shipping_methods'][0]->cod_name, array('class'=>'form-control field-validate', 'id'=>'cod_name')); ?>
                            ...
                            <div class="form-group">
								...
								<div class="col-sm-10 col-md-4">
									<?php echo Form::text('payment_currency', $result['shipping_methods'][0]->payment_currency, array('class'=>'form-control field-validate', 'id'=>'payment_currency')); ?>
